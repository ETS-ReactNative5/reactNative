...
const BellButton = ({isWhite, style, navigation}) => (
  <TouchableOpacity style={[styles.button, style]} onPress={() => console.log('pressed')}>
    <Icon
      family="ArgonExtra"
      size={16}
      name="bell"
  ...
  renderTabs = () => {
    ...
    return (  
      <Tabs  
        ...
        onClick={()=> console.log('pressssssss')}
        navigat={navigation.navigate("Param")}
        onChange={id => { 
